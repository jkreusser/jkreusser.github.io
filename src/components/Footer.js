...
export const Footer = () => {
    ...
    return (
        <footer className='max-w-screen-2xl mx-auto flex flex-col justify-center px-8 md:px-16 pt-32 md:pt-48 pb-16'>
            <span className='text-[2rem] leading-[2rem] sm:text-[3rem] sm:leading-[3rem] md:text-[4rem] md:leading-[4rem] lg:text-[5rem] lg:leading-[5rem] xl:text-[6rem] xl:leading-[6rem] 2xl:text-[8rem] 2xl:leading-[8rem] text-black'>{footerText}</span>
