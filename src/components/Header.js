...
const Header = () => {
    ...
    return (
        <section className='max-w-screen-2xl mx-auto flex flex-col justify-center my-32 px-8 md:px-16 mt-24 mb-32'>
            <span className='text-[2rem] leading-[2rem] sm:text-[3rem] sm:leading-[3rem] md:text-[4rem] md:leading-[4rem] lg:text-[5rem] lg:leading-[5rem] xl:text-[6rem] xl:leading-[6rem] 2xl:text-[9rem] 2xl:leading-[9rem]'>{headerText}</span>
            {/*
                    <Link>
